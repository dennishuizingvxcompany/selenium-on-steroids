...
<div>
    ...
    <div>
        <button id="toggleButton" onClick="toggleButton()">toggle button</button>
    </div>
</div>
<p>
<div>
...
<div>
    ...
    <input id="getTextOfElement" value="text within an element"/>
</div>
</p>
<div>
    <textarea>
...
<script>
    ...
    function updateText() {
        setTimeout(function () {
            document.getElementById("getTextOfElement").value = "Updated text of element";
        }, 5000);
    }
